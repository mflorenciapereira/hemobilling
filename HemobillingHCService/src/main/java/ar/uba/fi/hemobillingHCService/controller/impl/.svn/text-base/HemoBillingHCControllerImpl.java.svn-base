package ar.uba.fi.hemobillingHCService.controller.impl;
...
import ar.uba.fi.hemobillingHCService.remote.HemoBillingHCServer;

@Service("hemoBillingHCController")
public class HemoBillingHCControllerImpl implements HemoBillingHCController
{
	@Resource( name = "hemoBillingHCServer")
	private HemoBillingHCServer server;
	
	private Logger logger = Logger.getLogger(HemoBillingHCControllerImpl.class);
	...
	public void iniciar() throws RemoteException 
	{
        ...
        HemoBillingHCRemoteInterface stub = (HemoBillingHCRemoteInterface) UnicastRemoteObject.exportObject(server, 0);
