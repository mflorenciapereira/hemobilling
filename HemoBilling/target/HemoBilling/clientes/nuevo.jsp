...
function volverClientes() {
	...
	function validaryComitearForm() {
		...
		if( $('#tipoIVAid option:selected').val()=="-1" )
		{
			error = true;
			showMessage("Debe elegir un tipo.", "tipoIVAErrorID");			
		}
...
<div class="center_content">
	...
	<form:form cssClass="niceform" method="post" name="nuevoForm"
		id="nuevoForm" action="doNuevoCliente.htm"
		modelAttribute="nuevoclienteDTO">
			...
			<dl>
				...
				<dd>
					...
					<table>
						...
						<tr>
							<td><div id="tipoIVAErrorID" class="divError"></div></td>
						</tr>
					</table>
