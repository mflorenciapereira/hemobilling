...
<div class="center_content">
	...
	<h2>Modificar datos de un Usuario</h2>
	...
	<form:form cssClass="niceform" method="post" name="nuevoUsuarioForm" id="nuevoUsuarioForm" action="doEditarUsuario.htm" commandName="usuarioActualizarDTO" modelAttribute="usuarioActualizarDTO">
		...
		<fieldset>
			<dl>
				...
				<dd>
					<table>
					<tr> <td><form:input path="nombreUsuario" size="20" id="nombreUsuarioID" readonly="true"/></td></tr>
