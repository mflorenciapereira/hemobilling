...
<div class="center_content">
	<h2>Obtener informe de facturas emitidas</h2>
	...
	<div id="exitoMessageDivID" class="valid_box" style="display: none;"></div>
         ...
         <form:form id="facturasEmitidasForm" action="doGenerarInformeFacturasEmitidas.htm" method="post" cssClass="niceform" modelAttribute="filtroFacturasEmitidasDTO" commandName="filtroFacturasEmitidasDTO">
