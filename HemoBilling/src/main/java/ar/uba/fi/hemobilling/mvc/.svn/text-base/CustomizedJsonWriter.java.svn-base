 ...
 * @since 1.3.1  
 * 
 * With a quick fix for Maps usage. The writer dont treat a map like a collection.
 * @autor falberca
 */
public class CustomizedJsonWriter implements ExtendedHierarchicalStreamWriter {
    ...
    public CustomizedJsonWriter(Writer writer, char[] lineIndenter, String newLine) {
        this(writer, lineIndenter, newLine, 0);
    }

    public CustomizedJsonWriter(Writer writer, char[] lineIndenter) {
        this(writer, lineIndenter, "\n");
    }

    public CustomizedJsonWriter(Writer writer, String lineIndenter, String newLine) {
        this(writer, lineIndenter.toCharArray(), newLine);
    }

    public CustomizedJsonWriter(Writer writer, String lineIndenter) {
        this(writer, lineIndenter.toCharArray());
    }

    public CustomizedJsonWriter(Writer writer) {
     ...
     * @since 1.3.1
     */
    public CustomizedJsonWriter(Writer writer, char[] lineIndenter, String newLine, int mode) {
     ...
     * @since 1.3.1
     */
    public CustomizedJsonWriter(Writer writer, int mode) {
        this(writer, new char[]{' ', ' '}, "\n", mode);
    }
    ...
    @Override
    @SuppressWarnings("rawtypes") // No se puede evitar, la interfaz implementada no usa generics
    ...
    /* Modificamos este metodo para que al escribir un map no se genere el tag "[" 
     * que denota un array
     */
